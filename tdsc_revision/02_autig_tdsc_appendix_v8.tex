...
Construct $\mathsf{Part}_r$, inward/outward trees, and ranks for the included components\;
...
For each claimed component, require every tree edge to be reconstructed, its out-tree to reach every vertex from the root, and its in-tree to reach the root from every vertex\;
